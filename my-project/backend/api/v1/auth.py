...
from schemas.user import LoginRequest, LoginResponse, UserCreate, RefreshTokenRequest, RefreshTokenResponse
...
async def get_current_user_info(
    ...
    try:
        ...
        user_info = user_service.get_current_user(current_user.id)
        return BaseResponse(
            success=True,
            message="获取用户信息成功",
            data=user_info
